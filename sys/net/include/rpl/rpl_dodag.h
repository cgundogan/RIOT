...
ipv6_addr_t *rpl_get_my_preferred_parent(rpl_dodag_t *dodag);
void rpl_delete_parent(rpl_parent_t *parent, rpl_dodag_t *dodag);
...
void rpl_parent_update(rpl_parent_t *parent, rpl_dodag_t *dodag);

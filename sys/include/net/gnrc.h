 ...
 *
 * @note Do not forget to unregister with @ref gnrc_netreg_unregister() if you leave the function
 *       context
 *
 ...
 * command instead, again with access to the @ref net_gnrc_pkt.
 *
 * How To Use
 * ==========
 ...
 * @endcode
 *
 *   This will auto-initialize the network devices.

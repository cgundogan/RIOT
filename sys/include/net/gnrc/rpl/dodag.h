...
/**
 * @brief   Remove all parents from the @p instance.
 *
 * @param[in] instance  Pointer to the instance.
 */
void gnrc_rpl_instance_remove_all_parents(gnrc_rpl_instance_t *instance);

/**
 * @brief   Add a new parent with the IPv6 address @p addr to the @p instance.
 *
 ...
 */
bool gnrc_rpl_parent_add_by_addr(gnrc_rpl_instance_t *instance, ipv6_addr_t *addr,
...
/**
 * @brief   Get a parent with the IPv6 addr @p addr of the RPL @p instance.
 *
 * @param[in] instance  Pointer to the RPL instance
 * @param[in] addr      IPv6 address of the parent
 *
 ...
 * @return  NULL, otherwise.
 */
gnrc_rpl_parent_t *gnrc_rpl_parent_get(gnrc_rpl_instance_t *instance, ipv6_addr_t *addr);

/**
 * @brief   Update a @p parent of the @p instance.
 *
 * @param[in] instance  Pointer to the instance
 * @param[in] parent    Pointer to the parent
 */
 ...
 * @param[in] instance  Pointer to the RPL instance
 */
void gnrc_rpl_local_repair(gnrc_rpl_instance_t *instance);
#ifdef __cplusplus
}
#endif
